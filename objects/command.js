...
class Command{
     ...
     * @function execute
     * @memberof Command
     * @description Execute the command: process arguments then triggers {@link Command.actionGroup}
     * @author Gerkin
	 ...
	 * @method clone
	 * @memberof Command
	 * @description Re-parse command config to create a duplicate version modifyable
	 * @returns {Command} Clone
	 * @instance
	 * @public
	 * @author Gerkin
	 */
